...
page_title: "flashduty_field Resource - flashduty"
subcategory: ""
description: |-
  Manages a custom field in Flashduty.
---

# flashduty_field (Resource)
...
- `field_name` (String) The name of the field (must match ^[a-zA-Z_][a-zA-Z0-9_]{0,39}$).
- `field_type` (String) The type of the field (text, single_select, multi_select, checkbox).
- `value_type` (String) The value type of the field (string, bool).

### Optional

- `default_value` (String) The default value as JSON.
- `description` (String) The description of the field.
- `options` (String) The available options as JSON array (for single_select, multi_select types).

### Read-Only

- `created_at` (Number) The timestamp when the field was created.
- `id` (String) The unique identifier of the field.
- `status` (String) The status of the field (enabled, disabled, deleted).
